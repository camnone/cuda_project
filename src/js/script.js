window.addEventListener('DOMContentLoaded', function() {
 var circleProgress = (function(selector) {
  ...
  let tabs = document.querySelectorAll('.portfolio__tab'),
      tabsContent = document.querySelectorAll('.portfolio__contect'),
      tabsParent = document.querySelector('.portfolio__tabs');
      ...
      tabsParent.addEventListener('click', (e) =>{
        ...
        if(target && target.classList.contains('portfolio__tab')){
          tabs.forEach((item,i) =>{
            if(target == item){
              hideTabContent();
              showTabContent(i);
